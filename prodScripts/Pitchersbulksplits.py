...
def scrape_and_post_pitcher_data_helper(session, pitcher_id, year):
    # Check if 2023 totals exist before proceeding with 2025
    if not pitcher_totals_exists(session, pitcher_id, 2024):
        ...
        scrape_pitcher_totals_for_year(session, pitcher_id, 2024)
...
if len(sys.argv) > 1:
    ...
    date = "25-03-27"  # Example fallback date

year = 2025  # You can also add command line support for year if needed
