...
# File paths
input_file = 'C:/Users/travis.wye/Documents/tw/viz/Scripts/pitcherTablework/cleanedpitchers.csv'
...
print(f"Remaining pitchers have been written to {output_file}")
